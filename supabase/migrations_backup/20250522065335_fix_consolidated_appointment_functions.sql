-- Fix appointment functions with payment_link support
...
-- Now add the payment_link column
...
-- Create index for quicker lookup by payment_link
CREATE INDEX IF NOT EXISTS idx_appointment_purchases_payment_link ON public.appointment_purchases(payment_link);

-- Apply the consolidated appointment functions
-- Include the functions from consolidated_appointment_functions.sql here
