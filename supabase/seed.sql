...
--             image_urls[i],
--             ARRAY[
--                 (SELECT name FROM public.tags WHERE post_type = 'yoga' ORDER BY RANDOM() LIMIT 1),
--                 (SELECT name FROM public.tags WHERE post_type = 'yoga' AND name IN ('Beginner', 'Intermediate', 'Advanced') ORDER BY RANDOM() LIMIT 1),
--                 (SELECT name FROM public.tags WHERE post_type = 'yoga' AND name IN ('Flexibility', 'Strength', 'Balance', 'Relaxation') ORDER BY RANDOM() LIMIT 1)
--             ],
...
--             image_urls[i],
--              ARRAY[
--                 (SELECT name FROM public.tags WHERE post_type = 'dance' ORDER BY RANDOM() LIMIT 1),
--                 (SELECT name FROM public.tags WHERE post_type = 'dance' AND name IN ('Beginner', 'Intermediate', 'Advanced') ORDER BY RANDOM() LIMIT 1),
--                 (SELECT name FROM public.tags WHERE post_type = 'dance' AND name IN ('Cardio', 'Choreography', 'Expression', 'Rhythm') ORDER BY RANDOM() LIMIT 1)
--             ],
--             'public'::publish_status_enum,
--             'video'::media_type_enum,
...
--             image_urls[i],
--             ARRAY[
--                 (SELECT name FROM public.tags WHERE post_type = 'neuro_flow' ORDER BY RANDOM() LIMIT 1),
--                 (SELECT name FROM public.tags WHERE post_type = 'neuro_flow' AND name IN ('Brain Optimization', 'Neuroplasticity', 'Focus', 'Creativity') ORDER BY RANDOM() LIMIT 1),
--                 (SELECT name FROM public.tags WHERE post_type = 'neuro_flow' AND name IN ('Meditation', 'Breathwork', 'Visualization', 'Movement', 'Integration') ORDER BY RANDOM() LIMIT 1)
--             ],
--             'public'::publish_status_enum,
--             'video'::media_type_enum,
...
--             -- Tags
--             ARRAY[
--                 (SELECT name FROM public.tags WHERE post_type = 'event' AND name IN ('Conference', 'Workshop', 'Retreat', 'Seminar') ORDER BY RANDOM() LIMIT 1),
--                 (SELECT name FROM public.tags WHERE post_type = 'event' AND name IN ('Online', 'In-Person', 'Hybrid') ORDER BY RANDOM() LIMIT 1),
--                 (SELECT name FROM public.tags WHERE post_type = 'event' AND name IN ('Professional', 'Entertainment', 'Wellness') ORDER BY RANDOM() LIMIT 1)
--             ],
--             -- Status
--             'public'::publish_status_enum,
--             -- Event Type
...
--             -- Tags
--             ARRAY[
--                 (SELECT name FROM public.tags WHERE post_type = 'article' AND name IN ('Technology', 'Science', 'Health', 'Environment') ORDER BY RANDOM() LIMIT 1),
--                 (SELECT name FROM public.tags WHERE post_type = 'article' AND name IN ('Innovation', 'Research', 'Analysis', 'Opinion') ORDER BY RANDOM() LIMIT 1),
--                 'article'
--             ],
--             -- Status
--             'public'::publish_status_enum,
...
--             -- Tags
--             ARRAY[
--                 (SELECT name FROM public.tags WHERE post_type = 'service' AND name IN ('Coaching', 'Therapy', 'Consultation', 'Training') ORDER BY RANDOM() LIMIT 1),
--                 (SELECT name FROM public.tags WHERE post_type = 'service' AND name IN ('Online', 'In-Person', 'Hybrid') ORDER BY RANDOM() LIMIT 1),
--                 (SELECT name FROM public.tags WHERE post_type = 'service' AND name IN ('Wellness', 'Personal Development', 'Performance') ORDER BY RANDOM() LIMIT 1)
--             ],
--             -- Status
--             'public'::publish_status_enum,
