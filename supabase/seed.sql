...
BEGIN
    ...
    -- Extra direct service appointment purchases using actual service IDs
    -- This section specifically creates appointment purchases regardless of what's in service_ids array
    FOR i IN 1..10 LOOP
        -- Select a random buyer from our user pool
        buyer_id := random_user_ids[1 + (i % array_length(random_user_ids, 1))];
